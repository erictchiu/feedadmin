<?php
/* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	Separate comments mod - Prints comments and displays form for new comment entry
	++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
if ($ccount) { 
	...
	<div id='ID-$tbid[$i]' $comment_type_class[$i]>
		...
		<div class='tb-comment-subject'>$subject_content[$i]</div>
...
if (!$closed) {
	...
	<p id='tb-comment-link'><a href='" .TB_PATH. "comment-form.php?page={$_REQUEST['page']}'>{$lang['comdisplay6']}</a></p>"; // <!-- MOD -->
